...
================================== ====================================
GGD Package                        hg19-transcript-sequences-protein-coding-chr-regions-gencode-v1 
...
With ggd installed and an activated ggd channel (see :ref:`using-ggd`), install with::
   ...
   ggd install -c genomics hg19-transcript-sequences-protein-coding-chr-regions-gencode-v1 
