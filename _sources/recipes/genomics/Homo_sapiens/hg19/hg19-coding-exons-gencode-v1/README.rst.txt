.. _`hg19-coding-exons-gencode-v1`:
...
================================== ====================================
GGD Package                        hg19-coding-exons-gencode-v1 
...
Package's Data Files               hg19-coding-exons-gencode-v1.gtf.gz, hg19-coding-exons-gencode-v1.gtf.gz.tbi
Approximate Size of Each Data File hg19-coding-exons-gencode-v1.gtf.gz: **21.15M**, hg19-coding-exons-gencode-v1.gtf.gz.tbi: **474.30K**
...
Recipe                             https://github.com/gogetdata/ggd-recipes/tree/master/recipes/genomics/Homo_sapiens/hg19/hg19-coding-exons-gencode-v1
================================== ====================================
...
With ggd installed and an activated ggd channel (see :ref:`using-ggd`), install with::
   ...
   ggd install -c ggd-genomics hg19-coding-exons-gencode-v1

.. |downloads| image:: https://anaconda.org/ggd-genomics/hg19-coding-exons-gencode-v1/badges/downloads.svg
               :target: https://anaconda.org/ggd-genomics/hg19-coding-exons-gencode-v1