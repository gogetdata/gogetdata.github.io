...
=========================== ====================================
GGD Pacakge                 grch38-autosomal-dominant-genes-berg-blekhman-v1 
...
Size of Each Data File      grch38-autosomal-dominant-genes-berg-blekhman-v1.bed.gz: 147.51K, grch38-autosomal-dominant-genes-berg-blekhman-v1.bed.gz.tbi: 29.22K, grch38-autosomal-dominant-genes-berg-blekhman-v1.compliment.bed.gz: 86.03K, grch38-autosomal-dominant-genes-berg-blekhman-v1.compliment.bed.gz.tbi: 26.95K
...
With ggd insatlled and an activated ggd channel (see :ref:`using-ggd`), install with::
   ...
   ggd install -c ggd-genomics grch38-autosomal-dominant-genes-berg-blekhman-v1
