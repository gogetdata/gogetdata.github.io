.. _`grch38-cds-only-features-ensembl-v1`:
...
================================== ====================================
GGD Package                        grch38-cds-only-features-ensembl-v1 
...
Package's Data Files               grch38-cds-only-features-ensembl-v1.gtf.gz, grch38-cds-only-features-ensembl-v1.gtf.gz.tbi
Approximate Size of Each Data File grch38-cds-only-features-ensembl-v1.gtf.gz: **14.18M**, grch38-cds-only-features-ensembl-v1.gtf.gz.tbi: **512.87K**
Package Keywords                   Gene-Features, GTF, Ensembl-GTF, Ensembl-Gene-Set, Annotated-Transcripts, CDS-Only-Features
Package Dependencies:              gsort, htslib, zlib
Recipe                             https://github.com/gogetdata/ggd-recipes/tree/master/recipes/genomics/Homo_sapiens/GRCh38/grch38-cds-only-features-ensembl-v1
================================== ====================================
...
With ggd installed and an activated ggd channel (see :ref:`using-ggd`), install with::
   ...
   ggd install -c ggd-genomics grch38-cds-only-features-ensembl-v1
