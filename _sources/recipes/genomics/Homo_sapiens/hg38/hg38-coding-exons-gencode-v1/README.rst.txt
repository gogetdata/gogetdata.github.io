.. _`hg38-coding-exons-gencode-v1`:
...
================================== ====================================
GGD Package                        hg38-coding-exons-gencode-v1 
...
Package's Data Files               hg38-coding-exons-gencode-v1.gtf.gz, hg38-coding-exons-gencode-v1.gtf.gz.tbi
Approximate Size of Each Data File hg38-coding-exons-gencode-v1.gtf.gz: **18.32M**, hg38-coding-exons-gencode-v1.gtf.gz.tbi: **506.61K**
...
Recipe                             https://github.com/gogetdata/ggd-recipes/tree/master/recipes/genomics/Homo_sapiens/hg38/hg38-coding-exons-gencode-v1
================================== ====================================
...
With ggd installed and an activated ggd channel (see :ref:`using-ggd`), install with::
   ...
   ggd install -c ggd-genomics hg38-coding-exons-gencode-v1

.. |downloads| image:: https://anaconda.org/ggd-genomics/hg38-coding-exons-gencode-v1/badges/downloads.svg
               :target: https://anaconda.org/ggd-genomics/hg38-coding-exons-gencode-v1