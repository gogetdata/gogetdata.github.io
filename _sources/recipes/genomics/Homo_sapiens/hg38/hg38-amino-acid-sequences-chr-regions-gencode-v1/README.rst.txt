...
=========================== ====================================
GGD Pacakge                 hg38-amino-acid-sequences-chr-regions-gencode-v1 
...
Size of Each Data File      hg38-amino-acid-sequences-chr-regions-gencode-v1.fa.gz: 12.35M, hg38-amino-acid-sequences-chr-regions-gencode-v1.fa.gz.fai: 13.57M, hg38-amino-acid-sequences-chr-regions-gencode-v1.fa.gz.gzi: 12.39K
...
With ggd insatlled and an activated ggd channel (see :ref:`using-ggd`), install with::
   ...
   ggd install -c ggd-genomics hg38-amino-acid-sequences-chr-regions-gencode-v1
