...
=========================== ====================================
GGD Pacakge                 hg38-transcript-sequences-chr-regions-gencode-v1 
...
Size of Each Data File      hg38-transcript-sequences-chr-regions-gencode-v1.fa.gz: 82.90M, hg38-transcript-sequences-chr-regions-gencode-v1.fa.gz.fai: 31.16M, hg38-transcript-sequences-chr-regions-gencode-v1.fa.gz.gzi: 96.46K
...
With ggd insatlled and an activated ggd channel (see :ref:`using-ggd`), install with::
   ...
   ggd install -c ggd-genomics hg38-transcript-sequences-chr-regions-gencode-v1
