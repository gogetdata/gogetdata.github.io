...
================================== ====================================
GGD Package                        hg38-ncbi-refseq-ucsc-v1 
...
With ggd installed and an activated ggd channel (see :ref:`using-ggd`), install with::
   ...
   ggd install -c ggd-genomics hg38-ncbi-refseq-ucsc-v1

.. |downloads| image:: https://anaconda.org/ggd-genomics/hg38-ncbi-refseq-ucsc-v1/badges/downloads.svg
               :target: https://anaconda.org/ggd-genomics/hg38-ncbi-refseq-ucsc-v1